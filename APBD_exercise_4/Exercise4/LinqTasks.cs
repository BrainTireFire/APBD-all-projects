...
namespace Exercise4
{
    public static class LinqTasks
    {
        ...
        {
            //Query syntax
            var queryResult = from e in Emps 
                              where e.Job.Equals("Backend programmer") 
                              select e; // new {e.Job, e.Epmno} lub tak
            //Method syntax
        ...
        {
            var result = Emps.Where(e => e.Job.Equals("Frontend programmer") && e.Salary > 1000)
        ...
        {
            var result = Emps.Where(e1 => e1.Salary.Equals(Emps.Max(e2 => e2.Salary)));
            return result;
        }
        ...
        public static IEnumerable<object> Task7()
        {
            ...
            //Emps.GroupBy(e => e.Job, (key, e) => new { Praca = key, LiczbaPracownikow = e.Count() })
            return result;
        }
        ...
        {
            var result = Emps.Any(e => e.Job.Equals("Backend programmer"));
        ...
        {
            var secondSelect = Enumerable.Repeat(new {Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null },1);
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            var result = emps.Where(e => emps.Any(e2 => e2.Mgr != null && e2.Mgr.Empno == e.Empno)).OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
            return result;
        }
